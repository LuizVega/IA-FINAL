...
import { MobileScannerView } from './mobile/MobileScannerView';

export const MobileNavbar: React.FC = () => {
  const { currentView, setCurrentView, setScannerOpen, isScannerOpen, setEditingProduct, checkAuth, setCurrentFolder, isDemoMode } = useStore() as any;
